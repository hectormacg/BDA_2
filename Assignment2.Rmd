...
# de alguna manera. check
# 2) gelman.diag and plot tiene que ver como plotear parametros especificos check
# 3) poisson log likelihood esta saliendo muy raro el waic, checarlo. check
# 4) phi, checar que prior poner. check
# 5) posterior predictive de la pregunta 1.4
...
# effectiveSize(mcmc_samples[[2]][, c('beta[1]', 'beta[2]', 'beta[3]', 'beta[4]')])
# effectiveSize(mcmc_samples[[3]][, c('beta[1]', 'beta[2]', 'beta[3]', 'beta[4]')])
# effectiveSize(mcmc_samples[[4]][, c('beta[1]', 'beta[2]', 'beta[3]', 'beta[4]')])
#---------------------------------------------------------
...
```{r}
# Define the combinations of settings you want to test
# prior_ranges <- list(c(0.5, 0.5), c(1, 0.5), c(2, 0.5))
# prior_sigmas <- list(c(0.5, 0.5), c(1, 0.5), c(2, 0.5))
# max_edges <- list(c(1, 2), c(2, 4), c(3, 6))
...
prior_sigmas <- list(c(0.5, 0.5), c(1, 0.5), c(0.5, 0.25))
max_edges <- list(c(1, 2))
# Combination grid
settings <- expand.grid(
  prior.range = 1:length(prior_ranges),
