...
#In the predict() function, the first argument is the fitted bru model, the second argument is a dataframe of positions to be predicted, and the third argument is the formula to be predicted
#To plot the posterior mean of the spatial random effect plus the intercept term, we use formula=~floc+Intercept
#See https://inlabru-org.github.io/inlabru/reference/predict.bru.html for further examples
  
pred <- predict(res.ozone1, newdata = pix, formula=~floc+Intercept)
ggplot() +
    gg(prmesh) +
